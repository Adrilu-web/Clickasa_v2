document.addEventListener("DOMContentLoaded", () => {
        ...
        .then(data => {
            ...
            data.forEach((inmueble, indice) => {
                ...
                <div class="propiedad_card">
                    <img src="${inmueble.img}" alt="${inmueble.altimg}">
                    <h4>${inmueble.titulo}</h4>
                    <p>Precio: u$s${inmueble.precio} -   
    ...
    function agregarFav(inmueble) {
        ...
        if (typeof(Storage) !== "undefined") {
            ...
            if (!favoritos.some(fav => fav.titulo === inmueble.titulo)) {
    ...
    function mostrarFav() {
        ...
        container.innerHTML = '<h4>Favoritos</h4>'
          if (favoritos.length === 0) {
            ...
            favoritos.forEach((inmueble, index) => {
                ...
                <div class="favoritos_card">
                        <h4>${inmueble.titulo}</h4>
                        <p>Precio: u$s${inmueble.precio}</p>  
        ...
        function eliminarFav(id) {
            ...
            elemento[id].remove();       
            //ojo dar de baja 1 dar de alta 2 y borrar 1
        }
    }
                ...
                <span class="close_btn">&times;</span>
  				<div class="carousel_content">
                    <div class="carousel_elemento">
                        <img src="${inmueble.img}" alt="${inmueble.altimg}" width=200 height="200">
                    </div>
                    <div class="carousel_elemento">
                        <img src="${inmueble.img1}" alt="" width=200 height="200">
                    </div>
                    <div class="carousel_elemento">
                        <img src="${inmueble.img2}" alt="" width=200 height="200">
                    </div>
                    <div class="carousel_elemento">
                        <img src="${inmueble.img3}" alt="" width=200 height="200">
                    </div>
                                        <div class="carousel_elemento">
                        <img src="${inmueble.img4}" alt="" width=200 height="200">
                    </div>
                                        <div class="carousel_elemento">
                        <img src="${inmueble.img5}" alt="" width=200 height="200">
                    </div>
                </div>
                <h4>${inmueble.titulo}</h4>
                <p>Precio: u$s${inmueble.precio}</p>
